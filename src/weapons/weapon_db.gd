...
static func _build() -> Array[WeaponData]:
    ...
    list.append(_make({
        ...
        kick_deg = 1.6, knockback = 4.0, swap_time = 0.25, color = Color(0.72, 0.3, 0.22),
    }))
    list.append(_make({
    ...
    list.append(_make({
        ...
        kick_deg = 2.5, knockback = 7.0, swap_time = 0.3, color = Color(0.45, 0.5, 0.3),
    }))
    list.append(_make({
        ...
        kick_deg = 1.0, knockback = 6.0, swap_time = 0.3, color = Color(0.2, 0.55, 0.55),
    }))
    return list
