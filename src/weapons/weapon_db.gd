...
static func _build() -> Array[WeaponData]:
    ...
    list.append(_make({
        ...
        swap_time = 0.15, color = Color(0.55, 0.36, 0.2),
    }))
    list.append(_make({
        ...
        swap_time = 0.2, color = Color(0.3, 0.42, 0.62),
    }))
    list.append(_make({
        ...
        kick_deg = 1.6, knockback = 4.0, swap_time = 0.25, swap_cancel = true, color = Color(0.72, 0.3, 0.22),
    }))
    list.append(_make({
        ...
        kick_deg = 3.0, knockback = 6.0, swap_time = 0.3, color = Color(0.2, 0.4, 0.28),
    }))
    list.append(_make({
        ...
        swap_time = 0.4, color = Color(0.5, 0.35, 0.65),
    }))
    list.append(_make({
        ...
        kick_deg = 2.5, knockback = 7.0, swap_time = 0.3, swap_cancel = true, color = Color(0.45, 0.5, 0.3),
    }))
    list.append(_make({
        ...
        kick_deg = 1.0, knockback = 6.0, swap_time = 0.3, swap_cancel = true, color = Color(0.2, 0.55, 0.55),
    }))
    return list
